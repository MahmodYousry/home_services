                ...
                <ul class="collapse">
                    ...
                    @if(Route::has('login'))
                        @auth
                            @if(Auth::user()->utype==='ADM')
                                <li class="login-form"><a href="#" title="Register">My Account (Admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                        ...
                                        <li><a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('login-form').submit()">Logout</a></li>
                                    </ul>
                                </li>
                            ...
                            @endif
                            <form id="logout-form" method="POST" action="{{ route() }}" style="display:none;">
                                @csrf
                            </form>
                        @else
