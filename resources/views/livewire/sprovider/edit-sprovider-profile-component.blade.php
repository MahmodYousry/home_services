                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form-horizontal" wire:submit.prevent="updateProfile">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="file" wire:model="newimage" class="form-control-file">
                                                        @if ($newimage)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea name="about" wire:model="about" id="about" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="ser_c_id" class="control-label col-md-3">Service Category: </label>
                                                    <div class="col-md-9">
                                                        <select class="form-control" id="ser_c_id" wire:model="service_category_id">
                                                ...
                                                <div class="form-group">
                                                    <label for="ser_loca" class="control-label col-md-3">Service Locations zipcode/pincode: </label>
                                                    <div class="col-md-9">
                                                        <input type="text" wire:model="service_locations" id="ser_loca" class="form-control">
                                                    </div>
                                                </div>
