                            ...
                            <ul id="sponsors" class="tooltip-hover">
                                <li data-toggle="tooltip" title="" data-original-title="AC">
                                    <a href="servicesbycategory/1.html">
                                        <img src="{{ asset('images/sercat/service-icon.png') }}" alt="AC">
                                    </a>
                                </li>
                                <li data-toggle="tooltip" title="" data-original-title="Beauty">
                                    <a href="servicesbycategory/2.html">
                                        <img src="{{ asset('images/sercat/service-icon.png') }}" alt="Beauty">
                                    </a>
                                </li>
                                <li data-toggle="tooltip" title="" data-original-title="Plumbing">
                                    <a href="servicesbycategory/3.html">
                                        <img src="{{ asset('images/sercat/service-icon.png') }}" alt="Plumbing">
                                    </a>
                                </li>
