                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($scategories as $scategory)
                                            <tr>
                                                <th>{{$scategory->id}}</th>
                                                <th><img src="{{ asset('images/categories') }}/{{ $scategory->image }}" width="60" alt=""></th>
                                                <th>{{$scategory->name}}</th>
                                                <th>{{$scategory->slug}}</th>
                                                <th>
                                                ...
                                                <th>
                                                    ...
                                                    <a href="#" onclick="confirm('Are You Sure You Want To Delete This Service Category') || event.stopImmediatePropagation()" style="margin-left:10px" wire:click.prevent="deleteServiceCategory({{$scategory->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                                </th>
                                            </tr>
                                        @endforeach
                                    </tbody>
