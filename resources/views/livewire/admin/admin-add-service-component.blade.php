                        ...
                        <div class="col-md-8 col-md-offset-2 profile1">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-md-6">Add New Service</div>
                                        <div class="col-md-6">
                                ...
                                <div class="panel-body">
                                    ...
                                    @endif
                                    <form class="form-horizontal" action="" wire:submit.prevent="createService">
                                        @csrf
                                        {{-- name --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" name="thumbnail" wire:model="thumbnail" class="form-control-file">
